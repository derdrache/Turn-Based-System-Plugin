...
const CHARACTER_DISPLAY = preload("res://addons/Turn_Based_System/scenes/turn_order_bar/character_display.tscn")
const ON_TURN_ICON = preload("res://addons/Turn_Based_System/scenes/turn_order_bar/on_turn_icon.tscn")
